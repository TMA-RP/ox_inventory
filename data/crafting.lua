    ...
    },
    {
        items = { -- PIZZA
            ...
            },
            {
                ...
                metadata = { customname = "carpaccio", weight = -390, label = "Carpaccio", image = "fooddrink/carpaccio" },
                duration = 2000,
                count = 1,
            },
            {
                ...
                metadata = { customname = "beignets_risotto_arancini", weight = -400, label = "Beignets de risotto (arancini)", image = "fooddrink/beignets_risotto_arancini" },
                duration = 2000,
                count = 1,
            },
            {
            ...
            },
            {
                ...
                metadata = { customname = "pizza_prosciutto_funghi", weight = -100, label = "Pizza prosciutto funghi", image = "fooddrink/pizza_prosciutto_funghi" },
                duration = 2000,
                count = 1,
            },
            {
                ...
                metadata = { customname = "pizza_diavola", weight = -100, label = "Pizza diavola", image = "fooddrink/pizza_diavola" },
                duration = 2000,
                count = 1,
            },
            {
                ...
                metadata = { customname = "tiramisu", weight = -400, label = "Tiramisu", image = "fooddrink/tiramisu" },
                duration = 2000,
                count = 1,
            },
            {
